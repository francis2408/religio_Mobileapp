...
import 'package:msscc/private/screens/account/about.dart';
import 'package:msscc/private/screens/authentication/change_password.dart';
import 'package:msscc/private/screens/celebration/celebration_tab.dart';
import 'package:msscc/private/screens/circular&news_letter/circular_and_newsletter_tab.dart';
import 'package:msscc/private/screens/event/event.dart';
import 'package:msscc/private/screens/house/house.dart';
import 'package:msscc/private/screens/house/house_institution_list.dart';
import 'package:msscc/private/screens/house/house_members_list.dart';
import 'package:msscc/private/screens/institution/institution.dart';
import 'package:msscc/private/screens/institution/institution_members_list.dart';
import 'package:msscc/private/screens/member/member_tab.dart';
import 'package:msscc/private/screens/member/members_details.dart';
import 'package:msscc/private/screens/member/profile/member_profile_details.dart';
import 'package:msscc/private/screens/news/news.dart';
import 'package:msscc/private/screens/news/news_detail.dart';
import 'package:msscc/private/screens/notification/notification_list.dart';
import 'package:msscc/private/screens/obituary/obituary_tab.dart';
import 'package:msscc/private/screens/province/province_details.dart';
import 'package:msscc/private/screens/province/province_house_list.dart';
import 'package:msscc/private/screens/province/province_institution_list.dart';
...
import 'package:msscc/widget/helper_function/helper_function.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List newsList = [
    "Welcome to Missionaries of the Sacred Heart of Jesus and Mary - Bangalore Province.",
  ];
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            bottom: PreferredSize(
              preferredSize: Size.fromHeight(size.height * 0.06), // Set the preferred height
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text('Missionaries of the Sacred Heart of Jesus and  - Bangalore province', style: TextStyle(fontSize: size.height * 0.022, fontWeight: FontWeight.bold, color: Colors.white), textAlign: TextAlign.center,),
                  ],
                ),
              ),
            ),
                      ...
                      child: Wrap(
                        ...
                        children: [
                          ...
                          userRole == 'Institution' ? HomeCard(
                            ...
                            onPressed: () async {
                              userMember = 'Member';
                              String refresh = await Navigator.push(context, CustomRoute(widget: const HouseMembersListScreen()));
