...
import 'package:msscc/widget/custom_clipper/bezier_container.dart';
import 'package:msscc/widget/helper_function/helper_function.dart';
import 'package:msscc/widget/navigation_bar/navigation_bar.dart';
                    ...
                    children: <Widget>[
                      ...
                      RichText(
                        ...
                        text: TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text: ' the Sacred Heart of Jesus ',
                                style: TextStyle(color: Colors.black, fontSize: size.height * 0.024, fontWeight: FontWeight.w700,),
                              ),
                              TextSpan(
                                text: 'and Mary',
                                style: TextStyle(color: textColor, fontSize: size.height * 0.024, fontWeight: FontWeight.w700,),
                              ),
                              TextSpan(
                                text: ' - Bangalore Province',
                                style: TextStyle(color: menuPrimaryColor, fontSize: size.height * 0.024, fontWeight: FontWeight.w700,),
                              ),
                            ]),
                      ),
                      SizedBox(height: size.height * 0.02),
