                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  memberList[index]['mobile'] != '' && memberList[index]['mobile'] != null ? Row(
                                                    children: [
                                                      Text(
                                                        (memberList[index]['mobile']).split(',')[0].trim(),
                                                        style: GoogleFonts.secularOne(
                                                          color: mobileText,
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          if(memberList[index]['mobile'] != null && memberList[index]['mobile'] != '') IconButton(
                                                            onPressed: () {
                                                              (memberList[index]['mobile']).split(',').length != 1 ? showDialog(
                                                                context: context,
                                                                builder: (BuildContext context) {
                                                                  return AlertDialog(
                                                                          ...
                                                                          children: [
                                                                            ListTile(
                                                                              ...
                                                                              onTap: () {
                                                                                ...
                                                                                callAction((memberList[index]['mobile']).split(',')[0].trim());
                                                                              },
                                                                            ),
                                                                            const Divider(),
                                                                            ListTile(
                                                                              title: Text(
                                                                                (memberList[index]['mobile']).split(',')[1].trim(),
                                                                                style: const TextStyle(color: mobileText),
                                                                              ),
                                                                              onTap: () {
                                                                                Navigator.pop(context); // Close the dialog
                                                                                callAction((memberList[index]['mobile']).split(',')[1].trim());
                                                                              },
                                                                            ),
                                                                          ],
                                                                        ),
                                                                        ...
                                                                        Column(
                                                                          children: [
                                                                            ListTile(
                                                                              ...
                                                                              onTap: () {
                                                                                Navigator.pop(context); // Close the dialog
                                                                                smsAction((memberList[index]['mobile']).split(',')[0].trim());
                                                                              },
                                                                            ),
                                                                            const Divider(),
                                                                            ListTile(
                                                                              ...
                                                                              onTap: () {
                                                                                Navigator.pop(context); // Close the dialog
                                                                                smsAction((memberList[index]['mobile']).split(',')[1].trim());
                                                                              },
                                                                            ),
                                                                          ],
                                                                        ),
                                                                        ...
                                                                        Column(
                                                                          children: [
                                                                            ListTile(
                                                                              ...
                                                                              onTap: () {
                                                                                Navigator.pop(context); // Close the dialog
                                                                                whatsappAction((memberList[index]['mobile']).split(',')[0].trim());
                                                                              },
                                                                            ),
                                                                            const Divider(),
                                                                            ListTile(
                                                                              ...
                                                                              onTap: () {
                                                                                Navigator.pop(context); // Close the dialog
                                                                                whatsappAction((memberList[index]['mobile']).split(',')[1].trim());
                                                                              },
                                                                            ),
                                                                          ],
                                                                        ),
                                    ...
                                    Positioned(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          color: memberList[index]['member_type'] == 'Priest' ? Colors.green : memberList[index]['member_type'] == 'Deacon' ? Colors.redAccent : memberList[index]['member_type'] == 'Novice' ? Colors.indigo : memberList[index]['member_type'] == 'Brother' ? Colors.deepPurpleAccent : Colors.pinkAccent,
                                        ),
                                        child: memberList[index]['member_type'] == 'Priest' ? Text('P',
                                          style: GoogleFonts.heebo(
                                              fontSize: size.height * 0.02,
                                              color: Colors.white,
                                              fontWeight: FontWeight.bold
                                          ),
                                        ) : memberList[index]['member_type'] == 'Deacon' ? Text('D',
                                          style: GoogleFonts.heebo(
                                              fontSize: size.height * 0.02,
                                              color: Colors.white,
                                              fontWeight: FontWeight.bold
                                        ...
                                        ) : memberList[index]['member_type'] == 'Brother' ? Text('B',
                                          style: GoogleFonts.heebo(
                                              fontSize: size.height * 0.02,
                                              color: Colors.white,
                                              fontWeight: FontWeight.bold
