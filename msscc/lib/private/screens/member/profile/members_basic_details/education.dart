...
import 'package:msscc/private/screens/member/education/add_education.dart';
import 'package:msscc/private/screens/member/education/edit_education.dart';
...
class _MemberEducationScreenState extends State<MemberEducationScreen> {
  ...
  getEducationData() async {
    String educationUrl = '';
    educationUrl = "$baseUrl/search_read/res.member.education?domain=[('member_id','=',$memberId)]&fields=['study_level_id','program_id','institution','year_of_passing','state','mode','result','attachment']&order=year_of_passing desc";
                                          ...
                                          Column(
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  Container(width: size.width * 0.25, alignment: Alignment.topLeft, child: Text('Study Level', style: GoogleFonts.signika(fontSize: size.height * 0.02, fontStyle: FontStyle.italic, color: Colors.black87),)),
                                              ...
                                              Row(
                                                children: [
                                                  Container(width: size.width * 0.25, alignment: Alignment.topLeft, child: Text('Program', style: GoogleFonts.signika(fontSize: size.height * 0.02, fontStyle: FontStyle.italic, color: Colors.black87),)),
                                                  SizedBox(width: size.width * 0.02,),
                                                  education[index]['program_id'].isNotEmpty && education[index]['program_id'] != [] ? Text("${education[index]['program_id'][1]}", style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02),) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: Colors.grey, fontStyle: FontStyle.italic),),
                                                ],
                                              ),
                                              SizedBox(height: size.height * 0.015,),
                                              Row(
                                                children: [
                                                  Container(width: size.width * 0.25, alignment: Alignment.topLeft, child: Text('Institution', style: GoogleFonts.signika(fontSize: size.height * 0.02, fontStyle: FontStyle.italic, color: Colors.black87),)),
                                                  SizedBox(width: size.width * 0.02,),
                                              ...
                                              Row(
                                                children: [
                                                  Container(width: size.width * 0.25, alignment: Alignment.topLeft, child: Text('Mode', style: GoogleFonts.signika(fontSize: size.height * 0.02, fontStyle: FontStyle.italic, color: Colors.black87),)),
                                                  SizedBox(width: size.width * 0.02,),
                                              ...
                                              Row(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Container(width: size.width * 0.25, alignment: Alignment.topLeft, child: Text('Year of Passing', style: GoogleFonts.signika(fontSize: size.height * 0.02, fontStyle: FontStyle.italic, color: Colors.black87),)),
                                                  SizedBox(width: size.width * 0.02,),
