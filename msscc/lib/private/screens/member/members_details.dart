...
import 'members/holy_order.dart';
...
class _MembersDetailsTabBarScreenState extends State<MembersDetailsTabBarScreen> {
  ...
  getMemberDetails() async {
    var request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('id','=',$id)]&fields=['full_name','image_512','mobile','email','member_type']&context={"bypass":1}"""));
