...
import 'package:svdinm/private/screens/member/basic/edit_basic_details.dart';
...
class _MemberScreenState extends State<MemberScreen> {
  ...
  memberDetails() async {
    var request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('id','=',$id)]&fields=['member_name','name','middle_name','image_512','last_name','member_type','title','place_of_birth','dob','age','street','street2','place','city','district_id','state_id','country_id','zip','mobile','email','blood_group_id','role_ids']&context={"bypass":1}"""));
