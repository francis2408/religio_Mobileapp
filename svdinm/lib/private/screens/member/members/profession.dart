...
import 'package:svdinm/private/screens/member/profession/add_profession.dart';
import 'package:svdinm/private/screens/member/profession/edit_profession.dart';
...
class _MembersProfessionScreenState extends State<MembersProfessionScreen> {
  ...
  getProfessionData() async {
    ...
    professionUrl = "$baseUrl/search_read/res.profession?domain=[('member_id','=',$id)]&fields=['profession_date','place','type','years','state']&order=profession_date desc";
