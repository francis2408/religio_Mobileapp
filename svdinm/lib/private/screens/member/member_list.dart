...
class _MembersListScreenState extends State<MembersListScreen> {
  ...
  void _loadMore() async {
    if (_hasNextPage == true &&
      ...
      if(memberSelectedTab == "All") {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('id','!=',$memberId)]&fields=['full_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=member_type_ord, name asc"""));
      } else if(memberSelectedTab == 'Priest') {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('id','!=',$memberId),('member_type','=','Priest')]&fields=['full_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc"""));
      } else if(memberSelectedTab == 'Deacon') {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('id','!=',$memberId),('member_type','=','Deacon')]&fields=['full_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc"""));
      } else if(memberSelectedTab == 'Brother') {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('id','!=',$memberId),('member_type','=','Brother')]&fields=['full_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc"""));
      } else {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('id','!=',$memberId),('member_type','=','Novice')]&fields=['full_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc"""));
      }
  ...
  Future<void> getMembersListData() async {
    var request;
    if(memberSelectedTab == "All") {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('id','!=',$memberId)]&fields=['full_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=member_type_ord, name asc"""));
    } else if(memberSelectedTab == 'Priest') {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('id','!=',$memberId),('member_type','=','Priest')]&fields=['full_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=name asc"""));
    } else if(memberSelectedTab == 'Deacon') {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('id','!=',$memberId),('member_type','=','Deacon')]&fields=['full_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=name asc"""));
    } else if(memberSelectedTab == 'Brother') {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('id','!=',$memberId),('member_type','=','Brother')]&fields=['full_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=name asc"""));
    } else {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('id','!=',$memberId),('member_type','=','Novice')]&fields=['full_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=name asc"""));
    }
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
