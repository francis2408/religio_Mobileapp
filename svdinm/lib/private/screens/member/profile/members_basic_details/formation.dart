...
class _MemberFormationScreenState extends State<MemberFormationScreen> {
  ...
  getFormationData() async {
    ...
    formationUrl = "$baseUrl/search_read/res.formation?domain=[('member_id','=',$memberId)]&fields=['formation_stage_id','house_id','start_year','end_year','study_info','state']&order=start_year desc";
                                        ...
                                        Column(
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Container(width: size.width * 0.15, alignment: Alignment.topLeft, child: Text('Unit/LCF', style: GoogleFonts.signika(fontSize: size.height * 0.02, fontStyle: FontStyle.italic, color: Colors.black87),)),
                                                SizedBox(width: size.width * 0.02,),
                                                formation[index]['house_id'].isNotEmpty && formation[index]['house_id'] != [] ? Flexible(child: Text('${formation[index]['house_id'][1]}', style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02),)) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: Colors.grey, fontStyle: FontStyle.italic),),
                                              ],
                                            ),
                                          ],
                                        ),
