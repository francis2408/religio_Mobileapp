...
class MemberMinistryScreen extends StatefulWidget {
  const MemberMinistryScreen({Key? key}) : super(key: key);

  @override
  State<MemberMinistryScreen> createState() => _MemberMinistryScreenState();
}

class _MemberMinistryScreenState extends State<MemberMinistryScreen> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
          ...
          ) : ministryData.isNotEmpty ? Container(
                                    ...
                                    Column(
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Container(width: size.width * 0.2, alignment: Alignment.topLeft, child: Text('Unit/LCF', style: GoogleFonts.signika(fontSize: size.height * 0.02, fontStyle: FontStyle.italic, color: labelColor),)),
