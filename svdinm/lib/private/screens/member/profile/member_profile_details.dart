...
class _MemberProfileTabbarScreenState extends State<MemberProfileTabbarScreen> {
  ...
  getMemberDetails() async {
    var request = http.Request('GET', Uri.parse("$baseUrl/search_read/res.member?domain=[('id','=',$memberId)]&fields=['full_name','image_512','mobile','email','member_type']"));
                  ...
                  Container(
                    ...
                    child: Column(
                        children: [
                          ...
                          Expanded(
                            child: TabBarView(
                              children: memberType != 'Priest' ? tabsContent2 : tabsContent,
                            ),
                          )
                        ]),
                  ),
