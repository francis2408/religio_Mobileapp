...
import 'package:svdinm/private/screens/house/other_house_details.dart';
import 'package:svdinm/private/screens/house/other_house_institution_list.dart';
import 'package:svdinm/private/screens/house/other_house_members_list.dart';
...
class _ProvinceHouseListScreenState extends State<ProvinceHouseListScreen> {
  ...
  void _loadMore() async {
    if (_hasNextPage == true &&
      ...
      page += limit;
      var request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.community?domain=[('rel_province_id','=',$userProvinceId),('is_abroad','=',False),('is_other_diocese','=',False)]&fields=['image_512','name','superior_id','ministry_ids','members_count','institution_count']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc"""));
