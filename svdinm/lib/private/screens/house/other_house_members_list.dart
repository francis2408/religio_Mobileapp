...
class _OtherHouseMembersListScreenState extends State<OtherHouseMembersListScreen> {
  ...
  otherHouseMembers() async {
    var request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('community_id','=',$houseID)]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=name asc"""));
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                            onTap: () {
                              ...
                              indexName = otherMembers[index]['member_name'];
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        GestureDetector(
                                          onTap: () {
                                            otherMembers[index]['image_512'] != '' ? showDialog(
                                              context: context,
                                              builder: (BuildContext context) {
                                                return Dialog(
                                                  child: Image.network(otherMembers[index]['image_512'], fit: BoxFit.cover,),
                                                );
                                              },
                                            ) : showDialog(
                                              context: context,
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              image: DecorationImage(
                                                fit: BoxFit.cover,
                                                image: otherMembers[index]['image_512'] != null && otherMembers[index]['image_512'] != ''
                                                    ? NetworkImage(otherMembers[index]['image_512'])
                                              ...
                                              children: [
                                                Row(
                                                  children: [
                                                    Flexible(
                                                      child: Text(
                                                        otherMembers[index]['member_name'],
                                                        style: GoogleFonts.secularOne(
                                                          fontSize: size.height * 0.02,
                                                          color: textHeadColor,
                                                        ),
                                                ...
                                                Row(
                                                  children: [
                                                    otherMembers[index]['role_ids_name'] != null && otherMembers[index]['role_ids_name'] != '' ? Flexible(
                                                      child: Text(
                                                        otherMembers[index]['role_ids_name'],
                                                        style: GoogleFonts.secularOne(
                                                ...
                                                otherMembers[index]['community_id'].isNotEmpty && otherMembers[index]['community_id'] != [] && otherMembers[index]['community_id'] != '' ? SizedBox(
                                                  height: size.height * 0.008,
                                                ) : Container(),
                                                Row(
                                                  children: [
                                                    otherMembers[index]['community_id'].isNotEmpty && otherMembers[index]['community_id'] != [] && otherMembers[index]['community_id'] != '' ? Flexible(
                                                      child: Text(
                                                        otherMembers[index]['community_id'][1],
                                                        style: GoogleFonts.secularOne(
                                                          fontSize: size.height * 0.017,
                                                          color: valueColor,
                                                        ),
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        color: otherMembers[index]['member_type'] == 'Priest' ? Colors.green : otherMembers[index]['member_type'] == 'Deacon' ? Colors.redAccent : otherMembers[index]['member_type'] == 'Novice' ? Colors.indigo : otherMembers[index]['member_type'] == 'Brother' ? Colors.deepPurpleAccent : Colors.pinkAccent,
                                      ),
                                      child: otherMembers[index]['member_type'] == 'Priest' ? Text('P',
                                        style: GoogleFonts.heebo(
                                            fontSize: size.height * 0.02,
                                            color: Colors.white,
                                            fontWeight: FontWeight.bold
                                        ),
                                      ) : otherMembers[index]['member_type'] == 'Deacon' ? Text('D',
                                        style: GoogleFonts.heebo(
                                            fontSize: size.height * 0.02,
                                            color: Colors.white,
                                            fontWeight: FontWeight.bold
                                      ...
                                      ) : otherMembers[index]['member_type'] == 'Brother' ? Text('B',
                                        style: GoogleFonts.heebo(
                                            fontSize: size.height * 0.02,
                                            color: Colors.white,
                                            fontWeight: FontWeight.bold
