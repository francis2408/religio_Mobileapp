...
class DioceseInstitutionList extends StatefulWidget {
  const DioceseInstitutionList({Key? key}) : super(key: key);

  @override
  State<DioceseInstitutionList> createState() => _DioceseInstitutionListState();
}

class _DioceseInstitutionListState extends State<DioceseInstitutionList> {
  ...
  getInstitutionData() async {
    ...
    Map datas = mediumName == 'All' ? {
      ...
      "params": {
        "filter": "[['sub_category_id','=',$subCategoryId],['run_by','=','Diocesan'],['medium_id.name','=','$mediumName']]",
        "order": "vicariate_id asc",
        "query":"{id,image_1920,name,phone,mobile,email,diocese_id,vicariate_id,parish_id,institution_category_id,street,street2,city,district_id,state_id,country_id,zip,medium_id}"
      }
    };
