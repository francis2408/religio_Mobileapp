...
class DioceseInstitutionListScreen extends StatefulWidget {
  const DioceseInstitutionListScreen({Key? key}) : super(key: key);

  @override
  State<DioceseInstitutionListScreen> createState() => _DioceseInstitutionListScreenState();
}

class _DioceseInstitutionListScreenState extends State<DioceseInstitutionListScreen> {
  ...
  getInstitutionData() async {
    ...
    Map datas = {
      "params": {
        "filter": "[['diocese_id','=',$userDiocese],['run_by','=','Diocesan']]",
        "order": "name asc",
