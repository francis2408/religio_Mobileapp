...
class InstitutionCategoryScreen extends StatefulWidget {
  const InstitutionCategoryScreen({Key? key}) : super(key: key);

  @override
  State<InstitutionCategoryScreen> createState() => _InstitutionCategoryScreenState();
}

class _InstitutionCategoryScreenState extends State<InstitutionCategoryScreen> {
  ...
  List dioceseInstitutionCategory = [];
  ...
  getSubCategory(indexValue, indexName) {
    ...
    for(int i = 0; i < dioceseInstitution.length; i++) {
      if(categoryId == dioceseInstitution[i]['ministry_id'] && categoryTypeName == dioceseInstitution[i]['ministry']) {
        dioceseInstitutionCategory = dioceseInstitution[i]['institutions'];
      }
    }
  }
  ...
  getInstitutionData() async {
    ...
    Map datas = mediumName == 'Tamil Medium' ? {
      "params": {
        "filter": "[['sub_category_id','=',$subCategoryId],['run_by','=','Diocesan'],['medium_id.name','=','Tamil Medium']]",
      ...
      "params": {
        "filter": "[['sub_category_id','=',$subCategoryId],['run_by','=','Diocesan'],['medium_id.name','=','English Medium']]",
        "order": "vicariate_id asc",
        "query":"{id,image_1920,name,phone,mobile,email,diocese_id,vicariate_id,parish_id,institution_category_id,street,street2,city,district_id,state_id,country_id,zip,medium_id}"
      }
    } : {
      "params": {
        "filter": "[['sub_category_id','=',$subCategoryId],['run_by','=','Diocesan']]",
        "order": "vicariate_id asc",
        "query":"{id,image_1920,name,phone,mobile,email,diocese_id,vicariate_id,parish_id,institution_category_id,street,street2,city,district_id,state_id,country_id,zip,medium_id}"
      }
    };
          ...
          child: _isLoading ? SizedBox(
            ...
            child: Column(
              children: [
                ...
                categoryName == 'All' ? dioceseInstitution.isNotEmpty ? Expanded(
                    ...
                    child: Column(
                      children: [
                        ListView.builder(
                          ...
                          itemCount: dioceseInstitution.length, // Update the itemCount to 2 for two expansion tiles
                                        ...
                                        child: Container(
                                          ...
                                          child: ExpansionTile(
                                            ...
                                            onExpansionChanged: (newState) {
                                              if (newState) {
                                                setState(() {
                                                  ...
                                                  int indexValue;
                                                  String indexName;
                                                  indexValue = dioceseInstitution[index]['ministry_id'];
                                                  indexName = dioceseInstitution[index]['ministry'];
                                                  getSubCategory(indexValue, indexName);
                                                  selected2 = -1;
                                                  selected3 = -1;
                                            ...
                                            title: Container(
                                              ...
                                              child: Text(
                                                '${dioceseInstitution[index]['ministry']}',
                                            ...
                                            children: [
                                              dioceseInstitutionCategory.isNotEmpty ? ListView.builder(
                                                key: Key('builder ${selected2.toString()}'),
                                                shrinkWrap: true,
                                                physics: const NeverScrollableScrollPhysics(),
                                                itemCount: isCategoryExpanded ? dioceseInstitutionCategory.length : 0, // Update the itemCount to 2 for two expansion tiles
                                                    ...
                                                    children: [
                                                      ExpansionTile(
                                                        ...
                                                        onExpansionChanged: (newState) {
                                                          if (newState) {
                                                            setState(() {
                                                              selected2 = indexs;
                                                              int indexValue;
                                                              indexValue = dioceseInstitutionCategory[indexs]['category_id'];
                                                        ...
                                                        title: Container(
                                                          padding: const EdgeInsets.only(top: 10, bottom: 10),
                                                          child: Text(
                                                            "${dioceseInstitutionCategory[indexs]['category_name']} (${dioceseInstitutionCategory[indexs]['institution_count']})",
                                                            style: GoogleFonts.signika(
