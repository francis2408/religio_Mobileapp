...
class _PublicEventScreenState extends State<PublicEventScreen> {
  ...
  getDioceseEventData() async {
    String url = '$baseUrl/calendar.event';
    String today = DateFormat('yyyy-MM-dd').format(DateTime.now());
    Map data = {
      "params": {
        "order": "start asc, start_date asc",
        "filter": "[['type','=','public'],['calendar_type','=','Diocesan Calendar'],['start_date','>=','$today']]",
        "query": "{id,name,start,start_date,stop_date,allday,location,description_html,session}"
      }
    };
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              eventData[index]['description_html'].replaceAll(exp, '') != null && eventData[index]['description_html'].replaceAll(exp, '') != '' ? SizedBox(height: size.height * 0.01,) : Container(),
                                                              ...
                                                              child: Column(
                                                                children: [
                                                                  ...
                                                                  Expanded(
                                                                    child: SingleChildScrollView(
                                                                      child: Html(
                                                                        data: eventData[index]['description_html'],
                                                                      ),
                                                                    ),
                                                                  ),
                                                                ],
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  eventData[index]['location'] != '' && eventData[index]['location'] != null ? Text(eventData[index]['location'], style: GoogleFonts.signika(color: Colors.black87, fontSize: size.height * 0.02),) : Text("-", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: Colors.grey, fontStyle: FontStyle.italic),),
                                                ],
                                              ),
                                              eventData[index]['description_html'].replaceAll(exp, '') != null && eventData[index]['description_html'].replaceAll(exp, '') != '' ? SizedBox(height: size.height * 0.01,) : Container(),
                                              eventData[index]['description_html'].replaceAll(exp, '') != null && eventData[index]['description_html'].replaceAll(exp, '') != '' ? Row(
