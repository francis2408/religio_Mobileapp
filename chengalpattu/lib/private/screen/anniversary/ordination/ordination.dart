...
class _OrdinationScreenState extends State<OrdinationScreen> with TickerProviderStateMixin {
  ...
  getOrdinationData() async {
    ...
    if (response.statusCode == 200) {
      ...
      if(ordinationTab == 'Upcoming') {
        data = result['anniversary_results'];
      } else {
        data = result['all_anniversary'];
      }
      setState(() {
        _isLoading = false;
      });
      ordination = data;
      for(int i = 0; i < ordination.length; i++) {
        if(today == ordination[i]['ordination_date']) {
          _isToday = true;
        }
      }
    } else {
  ...
  void initState() {
    ...
    if(expiryDateTime!.isAfter(currentDateTime)) {
      ...
      _animation = Tween(begin: 0.5, end: 0.8).animate(_animationController);
      _animate();
            ...
            children: [
              ...
              ordination.isNotEmpty ? Row(
                ...
                children: [
                  ...
                  Text('${ordination.length}', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black),),
                        ...
                        children: [
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              if(today == ordination[index]['ordination_date']) {
                                                ...
                                                builder: (context, constraints) {
                                                  ...
                                                  return Stack(
                                                    ...
                                                    children: [
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                  ordination[index]['ordination_date'],
                                                                  style: GoogleFonts.reemKufi(fontWeight: FontWeight.bold, fontSize: size.height * 0.02, color: Colors.grey),
                                                                ),
                                                                // ordination[index]['mobile'] != null && ordination[index]['mobile'] != '' ? const SizedBox(height: 2,) : const SizedBox(height: 5,),
                                                                Row(
                                                                  children: [
                                                                    Flexible(
                                                                      child: Text(
                                                                        ordination[index]['mobile'],
                                                                    ...
                                                                    Row(
                                                                      mainAxisSize: MainAxisSize.min,
                                                                      children: [
                                                                        ordination[index]['mobile'] != null && ordination[index]['mobile'] != '' ? IconButton(
                                                                          onPressed: () {
                                                                            callAction(ordination[index]['mobile']);
                                                                          },
                                                                        ...
                                                                        ordination[index]['mobile'] != null && ordination[index]['mobile'] != '' ? IconButton(
                                                                          onPressed: () {
                                                                            smsAction(ordination[index]['mobile']);
                                                                          },
                                                                        ...
                                                                        ordination[index]['mobile'] != null && ordination[index]['mobile'] != '' ? IconButton(
                                                                          onPressed: () {
                                                                            whatsappAction(ordination[index]['mobile']);
                                                                          },
                                                      ...
                                                      //           image: AssetImage( "assets/images/happy-anniversary.png"),
                                                      //         ),
                                                      //       ),
                                                      //     ),
                                                      //   ),
                                                      ...
                                                      Positioned(
                                                        ...
                                                        child: GestureDetector(
                                                          onTap: () {
                                                            ordination[index]['img_data'] != '' ? showDialog(
                                                              context: context,
                                                              builder: (BuildContext context) {
                                                                return Dialog(
                                                                  child: Image.network(ordination[index]['img_data'], fit: BoxFit.cover,),
                                                                );
                                                              },
                                                            ) : showDialog(
                                                              context: context,
                                                          ...
                                                          child: SizedBox(
                                                            ...
                                                            child: CircleAvatar(
                                                              child: ClipOval(
                                                                child: ordination[index]['img_data'] != null && ordination[index]['img_data'] != '' ? Image.network(
                                                                    ordination[index]['img_data'],
                                                                    height: size.height * 0.1,
                                                                    width: size.width * 0.2,
                                                                    fit: BoxFit.cover
                                                                ) : Image.asset(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                ClipRRect(
                                                  ...
                                                  child: CircleAvatar(
                                                    child: ClipOval(
                                                      child: ordination[index]['img_data'] != null && ordination[index]['img_data'] != '' && ordination[index]['img_data'] != false ? Image.network(
                                                          ordination[index]['img_data'],
                                                          height: size.height * 0.15,
                                                          width: size.width * 0.2,
                                                          fit: BoxFit.cover
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: Stack(
                                          children: [
                                            ...
                                            if(today == ordination[index]['ordination_date']) Positioned(
