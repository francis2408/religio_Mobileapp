...
import 'package:chengai/private/screen/member/basic_details/family_info.dart';
import 'package:chengai/private/screen/member/basic_details/formation.dart';
import 'package:chengai/private/screen/member/basic_details/health.dart';
import 'package:chengai/private/screen/member/basic_details/holy_order.dart';
import 'package:chengai/private/screen/member/basic_details/ministry.dart';
...
class _MemberDetailsScreenState extends State<MemberDetailsScreen> {
  ...
  List<Widget> tabsContent = [
    ...
    if(selectMenu != 'Seminarian') const HolyOrderScreen(),
                ...
                child: SlideAnimation(
                  ...
                  child: FadeInAnimation(
                    child: DefaultTabController(
                      length: userLevel != 'Diocesan Member' ? selectedTab == "Religious" ? tabs.length : userLevel == 'Diocese Mgmt Admin' && membershipType == 'RE' && mshipType == 'RE' ? tabs.length : userLevel == 'Diocese Mgmt Admin' && membershipType == 'SE' && mshipType == 'RE' ? tabs.length : tabsContent.length : tab.length,
                      child: Stack(
                          children: [
                            Positioned.fill(
                              top: 0,
                            ...
                            Container(
                              ...
                              child: Column(
                                  children: [
                                      ...
                                      children: [
                                        ...
                                        Container(
                                            ...
                                            child: IconButton(
                                              ...
                                              icon: Icon(LineAwesomeIcons.what_s_app, size: size.height * 0.032,),
                                              color: Colors.green,
                                            )
                                        ),
                                        Container(
                                    ...
                                    Container(
                                      alignment: userLevel != 'Diocesan Member' ? selectedTab == "Religious" ? Alignment.center : userLevel == 'Diocese Mgmt Admin' && membershipType == 'RE' && mshipType == 'RE' ? Alignment.center : userLevel == 'Diocese Mgmt Admin' && membershipType == 'SE' && mshipType == 'RE' ? Alignment.center : Alignment.topLeft : Alignment.center,
                                      ...
                                      child : TabBar(
                                          ...
                                          tabs: userLevel != 'Diocesan Member' ? selectedTab == "Religious" ? [
                                            Tab(
                                              child: Container(
                                          ...
                                          ] : userLevel == 'Diocese Mgmt Admin' && membershipType == 'RE' && mshipType == 'RE' ? [
                                            Tab(
                                              child: Container(
                                                padding: EdgeInsets.only(left: size.width * 0.05, right: size.width * 0.05),
                                                decoration: BoxDecoration(
                                          ...
                                          ] : userLevel == 'Diocese Mgmt Admin' && membershipType == 'SE' && mshipType == 'RE' ? [
                                            Tab(
                                              child: Container(
                                                padding: EdgeInsets.only(left: size.width * 0.05, right: size.width * 0.05),
                                                decoration: BoxDecoration(
                                    ...
                                    Expanded(
                                      child: TabBarView(
                                        children: userLevel != 'Diocesan Member' ? selectedTab == "Religious" ? tabs : selectedTab == 'Associates' ? tabs : userLevel == 'Diocese Mgmt Admin' && membershipType == 'RE' && mshipType == 'RE' ? tabs : userLevel == 'Diocese Mgmt Admin' && membershipType == 'SE' && mshipType == 'RE' ? tabs : tabsContent : tab,
                                      ),
                                    )
                                  ]),
                            ),
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  member[index]['image_1920'] != '' ? showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return Dialog(
                                        child: Image.network('assets/images/profile.png', fit: BoxFit.cover,),
                                      );
                                    },
                                  );
                                },
