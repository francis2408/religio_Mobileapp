...
class ProfileBasicDetailsScreen extends StatefulWidget {
  ...
  @override
  State<ProfileBasicDetailsScreen> createState() => _ProfileBasicDetailsScreenState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          String refresh = await Navigator.of(context).push(CustomRoute(widget: const EditBasicDetailsScreen()));
