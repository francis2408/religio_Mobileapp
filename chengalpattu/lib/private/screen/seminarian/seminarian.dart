...
class SeminarianScreen extends StatefulWidget {
  const SeminarianScreen({Key? key}) : super(key: key);

  @override
  State<SeminarianScreen> createState() => _SeminarianScreenState();
}

class _SeminarianScreenState extends State<SeminarianScreen> {
  ...
  void _loadMore() async {
    if(_hasNextPage == true &&
      ...
      Map data = userMember != '' && seminarianTab == 'All' ? {
        "params": {
          "filter": "[['diocese_id','=',$userDiocese],['id','!=',$userMember],['member_type_id.name','=','Brother'],['formation_ids.state','=','Active']]",
          "order": "member_type_sequence, name asc",
          "page_size": limit,
          "page": page,
          "query": "{id,name,member_name,image_1920,email,mobile,role_ids,parish_name,membership_type,formation_ids{formation_stage_id,study_info}}"
        }
      } : {
        "params": {
          "filter": "[['diocese_id','=',$userDiocese],['member_type_id.name','=','Brother'],['formation_ids.state','=','Active'],['formation_ids.formation_stage_id.name','=','$seminarianTab']]",
          "order": "member_type_sequence, name asc",
          "page_size": limit,
          "page": page,
          "query": "{id,name,member_name,image_1920,email,mobile,role_ids,parish_name,membership_type,formation_ids{formation_stage_id,study_info}}"
  ...
  void getSeminariansData() async {
    setState(() {
      _isLoading = true;
    });

    String url = '$baseUrl/res.member';
    Map datas = userMember != '' && seminarianTab == 'All' ? {
      "params": {
        "filter": "[['diocese_id','=',$userDiocese],['id','!=',$userMember],['member_type_id.name','=','Brother'],['formation_ids.state','=','Active']]",
        "order": "member_type_sequence, name asc",
        "page_size": limit,
  ...
  void getSeminariansListData() async {
    setState(() {
      _isLoading = true;
    });
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Row(
                                                              children: [
                                                                members[index]['formation_ids'] != null && members[index]['formation_ids'] != [] ? Flexible(
                                                                  child: RichText(
                                                                    textAlign: TextAlign.left,
                                                                    text: TextSpan(
                                                                        text: members[index]['formation_ids'][0]['formation_stage_id']['name'],
                                                                        style: TextStyle(
                                                                          fontSize: size.height * 0.017,
                                                                          fontWeight: FontWeight.bold,
                                                                          color: Colors.deepOrangeAccent,
                                                                        ),
                                                                        children: members[index]['formation_ids'][0]['study_info'] != null && members[index]['formation_ids'][0]['study_info'] != '' ? [
                                                                          const TextSpan(
                                                                            text: ' , ',
                                                                          ),
                                                                          TextSpan(
                                                                            text: '${members[index]['formation_ids'][0]['study_info']}',
                                                                            style: TextStyle(
                                                                                fontSize: size.height * 0.017,
                                                                                color: Colors.deepOrangeAccent,
                                                                                fontStyle: FontStyle.italic
