...
import 'custom_clipper/bottom_nav_bar.dart';
import 'theme_color/color.dart';
...
String house_name = '';
int? house_memberId;
String house_member_name = '';
int? institution_id;
String institution_name = '';
int? institution_memberId;
String institution_member_name = '';
int? house_institution_id;
String house_institution_name = '';

var primaryColor = Colors.teal;
var secondaryColor = const Color(0xFF7BC496);

// const backgroundColor = Color(0xFF19C297);
// const screenBackgroundColor = Color(0xFFD1E8E0);
const buttonColor = Color(0xFF5256AE);
const lightColor = Color.fromARGB(255, 140, 145, 249);
const lightGreenColor = Colors.lightGreen;
var filename;
var birthday_count;

String houseInstitution = '';
...
class NoResult extends StatelessWidget {
  const NoResult({Key? key, required this.onPressed,}) : super(key: key);
    ...
    return ElevatedButton(
      ...
      child: widget.isLoading ? SizedBox(
        ...
        child: CircularProgressIndicator(
          ...
          : Text(widget.text, style: GoogleFonts.lora(fontSize: widget.size, fontWeight: FontWeight.bold),),
    );
  }
}
...
class UpdateAlertDialog extends StatefulWidget {
  ...
  const UpdateAlertDialog({Key? key, required this.message, required this.message2, required this.onCancelPressed, required this.onUpdatePressed}) : super(key: key);
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      widget.onUpdatePressed(); // Return true when Yes button is pressed
                    },
                    style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.green
                    ),
