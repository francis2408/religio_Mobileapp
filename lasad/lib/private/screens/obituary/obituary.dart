...
class _ObituaryScreenState extends State<ObituaryScreen> with TickerProviderStateMixin {
  ...
  getDeathMembersData() async {
    var request = sectorTab == 'Indian Sector' ? http.Request('GET', Uri.parse("$baseUrl/call/res.member/api_get_death_members?args=[$userProvinceId]")) : http.Request('GET', Uri.parse("$baseUrl/call/res.member/api_get_death_members?args=[$sri_sector_id]"));
            ...
            child: _isLoading ? Center(
              ...
              children: [
                ...
                deathData.isNotEmpty ? Row(
                  ...
                  children: [
                    const Text('Total Count :', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: valueColor),),
                    const SizedBox(width: 3,),
                    Text('${deathData.length}', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: valueColor),)
                  ],
                ) : Container(),
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          ClipRRect(
                                            ...
                                            child: CircleAvatar(
                                              child: ClipOval(
                                                child: deathData[index]['image_1920'] != null && deathData[index]['image_1920'] != '' ? Image.network(
                                                    deathData[index]['image_1920'],
                                                    height: size.height * 0.15,
                                                    width: size.width * 0.2,
                                                    fit: BoxFit.cover
                                                ) : Image.asset(
