...
class ProvinceCommissionsScreen extends StatefulWidget {
  const ProvinceCommissionsScreen({Key? key}) : super(key: key);

  @override
  State<ProvinceCommissionsScreen> createState() => _ProvinceCommissionsScreenState();
}

class _ProvinceCommissionsScreenState extends State<ProvinceCommissionsScreen> {
  ...
  getCommissionData() async {
    var request = sectorTab == 'Indian Sector' ? http.Request('GET', Uri.parse("""$baseUrl/call/res.member/get_commission_details""")) : http.Request('GET', Uri.parse("""$baseUrl/call/res.member/get_commission_details"""));
...
//     var request = http.Request('GET', Uri.parse("$baseUrl/call/res.religious.province/api_get_pro_council_members?args=[$userProvinceId]"));
//     request.headers.addAll(headers);
//
//     http.StreamedResponse response = await request.send();
//
...
//           councilName = council[i]['name'];
//           members = council[i]['memberIds'];
//         }
//       } else {
//         council = [];
//       }
...
//             ),
//           ),
//         ) : council.isNotEmpty ? AnimationLimiter(
...
//                         child: Column(
//                           children: [
//                             councilName != '' && councilName != null ? Card(
//                               shape: RoundedRectangleBorder(
//                                 borderRadius: BorderRadius.circular(15.0),
//                               ),
//                               child: ListTile(
//                                 title: Text("Name", style: GoogleFonts.signika(fontSize: size.height * 0.02, fontStyle: FontStyle.italic, color: Colors.black87),),
//                                 subtitle: Row(
//                                   children: [
//                                     Flexible(child: Text(councilName, style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02),)),
//                                   ],
//                                 ),
//                               ),
//                             ) : Card(
...
//                                           Flexible(
//                                             child: Text(
//                                               members[indexs]['member_name'].toUpperCase(),
//                                               style: GoogleFonts.secularOne(
//                                                   letterSpacing: 1,
//                                                   fontSize: size.height * 0.018,
//                                                   color: textColor
...
//                                             height: size.height * 0.01,
//                                           ),
//                                           members[indexs]['role'] != null && members[indexs]['role'] != '' ? Flexible(
//                                             child: Text(
//                                               members[indexs]['role'],
//                                               style: TextStyle(
//                                                 letterSpacing: 0.5,
