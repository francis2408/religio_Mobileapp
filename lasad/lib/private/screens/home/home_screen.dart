...
import 'package:lasad/private/screens/account/about.dart';
import 'package:lasad/private/screens/celebration/celebration.dart';
import 'package:lasad/private/screens/change_password/change_password.dart';
import 'package:lasad/private/screens/circular&news_letter/circular_and_newsletter_tab.dart';
import 'package:lasad/private/screens/event/event.dart';
import 'package:lasad/private/screens/house/house.dart';
...
import 'package:lasad/private/screens/member/member.dart';
import 'package:lasad/private/screens/member/members_details.dart';
import 'package:lasad/private/screens/member/profile/member_profile_details.dart';
import 'package:lasad/private/screens/news/news.dart';
import 'package:lasad/private/screens/news/news_detail.dart';
import 'package:lasad/private/screens/notification/notification_list.dart';
import 'package:lasad/private/screens/obituary/death_tab.dart';
import 'package:lasad/private/screens/obituary/obituary_tab.dart';
import 'package:lasad/private/screens/province/province_house_list.dart';
import 'package:lasad/private/screens/province/province_institution_list.dart';
import 'package:lasad/private/screens/province/province_tab.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  getSectorData() async {
    var request = http.Request('GET', Uri.parse("$baseUrl/search_read/res.religious.province?domain=[('institute_id','=',1)]&fields=['name']"));
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
    ...
    if (response.statusCode == 200) {
      ...
      for(int i = 0; i < sector.length; i++) {
        if(sector[i]['id'] == 1) {
          indian_sector_id = sector[i]['id'];
        }
        if(sector[i]['id'] == 2) {
          sri_sector_id = sector[i]['id'];
        }
      }
  ...
  getDeathMembersData() async {
    ...
    if (response.statusCode == 200) {
      ...
      for(int i = 0; i < data.length; i++) {
        DateTime dateTime = Jiffy.parse(data[i]['death_date'], pattern: 'dd-MM-yyyy').dateTime;
        String formattedDate = Jiffy.parseFromDateTime(dateTime).format(pattern: "dd - MMMM" );
        if(today == formattedDate) {
            ...
            children: [
                Column(
                  children: [
                    ...
                    Transform.translate(
                      offset: Offset(-3, -size.height / 25),
                      child: Padding(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      fit: BoxFit.cover,
                                      image: memberImage != '' && memberImage.isNotEmpty
                    ...
                    Transform.translate(
                      offset: Offset(-3, -size.height / 40),
                      child: Column(
                        children: [
                        ...
                        child: Wrap(
                          ...
                          children: [
                            HomeCard(
                              ...
                              title: "Profile",
                              colorOne: const Color(0xff761d77),
                              colorTwo: const Color(0xffef80f1),
                              homeIconColor: const Color(0xFFf6ddf7),
                              homeIconSize: 35,
                            ),
                            HomeCard(
                              onPressed: () async {
                                String refresh = await Navigator.push(context, CustomRoute(widget: const PrivateProvinceTabScreen()));
                              ...
                              title: "Sector",
                              colorOne: const Color(0xff048a6f),
                              colorTwo: const Color(0xff59efcb),
                            ...
                            userRole == 'Religious Province' ? HomeCard(
                              ...
                              title: "House",
                              colorOne: const Color(0xFF044F94),
                              colorTwo: const Color(0xFF4CC6F3),
                            ...
                            userRole == 'Institution' ? HomeCard(
                              ...
                              onPressed: () async {
                                userMember = 'Member';
                                String refresh = await Navigator.push(context, CustomRoute(widget: const PrivateMemberScreen()));
                            ...
                            total != 0 ? Stack(
                              children: [
                                HomeCard(
                                  onPressed: () async {
                                    String refresh = await Navigator.push(context, CustomRoute(widget: const PrivateCelebrationScreen()));
                            ...
                            HomeCard(
                              onPressed: () async {
                                String refresh = await Navigator.push(context, CustomRoute(widget: const PrivateDeathScreen()));
