...
class _MembersListScreenState extends State<MembersListScreen> {
  ...
  void _loadMore() async {
    if (_hasNextPage == true &&
      ...
      page += limit;
      var request = sectorTab == 'Indian Sector' ? http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId)]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc""")) : http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$sri_sector_id)]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc"""));
  ...
  Future<void> getMembersListData(String searchWord) async {
    ...
    var request = sectorTab == 'Indian Sector' ? http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|',('member_name','ilike','$searchName'),('rel_province_id','=',$userProvinceId)]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=name asc""")) : http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|',('member_name','ilike','$searchName'),('rel_province_id','=',$sri_sector_id)]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=name asc"""));
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
                                                    ...
                                                    Positioned(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                          ...
                                                          color: results[index]['member_type'] == 'Lay Brother' ? Colors.indigo : Colors.transparent,
                                                        ),
                                                        child: results[index]['member_type'] == 'Lay Brother' ? Text('LB',
                                                  ...
                                                  children: [
                                                    ...
                                                    Positioned(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                          borderRadius: BorderRadius.circular(5),
                                                          color: members[index]['member_type'] == 'Lay Brother' ? Colors.indigo : Colors.transparent,
                                                        ),
                                                        child: members[index]['member_type'] == 'Lay Brother' ? Text('LB',
                                                          style: GoogleFonts.heebo(
                                                              fontSize: size.height * 0.02,
                                                              color: Colors.white,
                                                              fontWeight: FontWeight.bold
