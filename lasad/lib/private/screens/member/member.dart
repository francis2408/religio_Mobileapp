...
class PrivateMemberScreen extends StatefulWidget {
  const PrivateMemberScreen({Key? key}) : super(key: key);

  @override
  State<PrivateMemberScreen> createState() => _PrivateMemberScreenState();
}

class _PrivateMemberScreenState extends State<PrivateMemberScreen> with SingleTickerProviderStateMixin {
