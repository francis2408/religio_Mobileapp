...
class PrivateCelebrationScreen extends StatefulWidget {
  const PrivateCelebrationScreen({Key? key}) : super(key: key);

  @override
  State<PrivateCelebrationScreen> createState() => _PrivateCelebrationScreenState();
}

class _PrivateCelebrationScreenState extends State<PrivateCelebrationScreen> with SingleTickerProviderStateMixin {
  late TabController _tabController;

  List tabs = ["Indian Sector", "Sri Lankan Sector"];

  List<Widget> tabsContent = [
    const PrivateMembersBirthdayScreen(),
    const PrivateMembersBirthdayScreen(),
  ];
