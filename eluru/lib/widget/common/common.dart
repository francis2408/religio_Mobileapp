// Test Server
// const baseUrl = 'http://teststjpmcelluru.cristolive.org/api';
// const db = 'cristo_teststjpmcelluru';
// Live Server
const baseUrl = 'https://app.stjosephsprovince.org/api';
const db = 'cristo_sjpmc';
