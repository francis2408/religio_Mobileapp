...
import 'package:shm/private/screens/account/about.dart';
import 'package:shm/private/screens/authentication/change_password.dart';
import 'package:shm/private/screens/authentication/login.dart';
import 'package:shm/private/screens/celebration/celebration_tab.dart';
import 'package:shm/private/screens/circular&news_letter/circular_and_newsletter_tab.dart';
import 'package:shm/private/screens/event/event.dart';
import 'package:shm/private/screens/house/house.dart';
import 'package:shm/private/screens/house/house_institution_list.dart';
import 'package:shm/private/screens/house/house_members_list.dart';
import 'package:shm/private/screens/institution/institution.dart';
import 'package:shm/private/screens/institution/institution_members_list.dart';
import 'package:shm/private/screens/member/member_tab.dart';
...
import 'package:shm/private/screens/news/news.dart';
import 'package:shm/private/screens/news/news_detail.dart';
import 'package:shm/private/screens/notification/notification_list.dart';
import 'package:shm/private/screens/obituary/obituary_tab.dart';
import 'package:shm/private/screens/province/province_details.dart';
import 'package:shm/private/screens/province/province_house_list.dart';
import 'package:shm/private/screens/province/province_institution_list.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List newsList = [
    "Welcome to Society of Sisters of the Helpers of Mary.",
  ];
  ...
  getData() async {
    ...
    if(expiryDateTime!.isAfter(currentDateTime)) {
      ...
      if(userRole == 'Religious Province') {
        url = "$baseUrl/search_read/org.image?fields=['name','image_512']&domain=[('rel_province_id','=',$userProvinceId)]";
      } else if(userRole == 'House/Community') {
        url = "$baseUrl/search_read/org.image?fields=['name','image_512']&domain=[('house_id','=',$userCommunityId)]";
      } else if(userRole == 'Institution') {
        url = "$baseUrl/search_read/org.image?fields=['name','image_512']&domain=[('institution_id','=',$userInstituteId)]";
      } else {
        url = "$baseUrl/search_read/org.image?fields=['name','image_512']&domain=[('rel_province_id','=',$userProvinceId)]";
      }
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            bottom: PreferredSize(
              preferredSize: Size.fromHeight(size.height * 0.04), // Set the preferred height
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text('Society of the Helpers of Mary', style: TextStyle(fontSize: size.height * 0.023, fontWeight: FontWeight.bold, color: Colors.white), textAlign: TextAlign.center,),
                  ],
                ),
              ),
            ),
                    ...
                    children: [
                      image.isNotEmpty ? CarouselSlider.builder(
                        ...
                        itemBuilder: (context, index, realIndex) {
                          final urlImage = image[index]['image_512'];
                          return ClipRRect(
                            borderRadius:
                        ...
                        itemBuilder: (context, index, realIndex) {
                          final urlImage = bannerImage[index]['image_512'];
                          return ClipRRect(
                            borderRadius:
                            const BorderRadius.all(Radius.circular(20.0)),
                            child: Image.network(urlImage, fit: BoxFit.fill, width: 1000.0),
                      ...
                      child: Wrap(
                        ...
                        children: [
                          ...
                          userRole == 'Religious Province' ? HomeCard(
                            ...
                            title: "Institution",
                            homeIconSize: 35,
                          ) : userRole == 'House/Community' ? userInstituteId == '' ? HomeCard(
                            onPressed: () async {
                              institution = 'Institution';
                              String refresh = await Navigator.push(context, CustomRoute(widget: const ProvinceInstitutionListScreen()));
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: const LinearGradient(
                  colors: [menuPrimaryColor, menuSecondaryColor], // Add your gradient colors here
