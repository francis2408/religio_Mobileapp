...
class AddMemberHistoryScreen extends StatefulWidget {
  const AddMemberHistoryScreen({Key? key}) : super(key: key);

  @override
  State<AddMemberHistoryScreen> createState() => _AddMemberHistoryScreenState();
}

class _AddMemberHistoryScreenState extends State<AddMemberHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            title: const Text('Add Member History'),
                ...
                child: Form(
                  ...
                  child: ListView(
                    children: [
                      ...
                      memberID.isNotEmpty && memberID == '' ? Container(
                      ...
                      memberID.isNotEmpty && memberID == '' ? isMember ? Container(
                          alignment: Alignment.topLeft,
