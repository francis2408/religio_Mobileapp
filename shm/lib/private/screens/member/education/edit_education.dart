    ...
    if (response.statusCode == 200) {
      ...
      for(int i = 0; i < educationData.length; i++) {
        ...
        if(educationData[i]['attachment'] != '') {
          ...
          attachmentName = educationData[i]['attachment_name'];
                    ...
                    child: DropDownTextField(
                      ...
                      textFieldDecoration: InputDecoration(
                        ...
                        hintStyle: GoogleFonts.breeSerif(
                          color: level != '' ? Colors.black87 : labelColor2,
                          fontStyle: level != '' ? FontStyle.normal : FontStyle.italic,
                        ),
                  ...
                  Container(
                    ...
                    child: DropDownTextField(
                      ...
                      textFieldDecoration: InputDecoration(
                        ...
                        hintStyle: GoogleFonts.breeSerif(
                          color: study != '' ? Colors.black87 : labelColor2,
                          fontStyle: study != '' ? FontStyle.normal : FontStyle.italic,
                        ),
                        enabledBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(10),
                          borderSide: const BorderSide(
                    ...
                    children: [
                      ...
                      Flexible(
                        child: Row(
                          ...
                          children: [
                            _attachFileName != null && _attachFileName != '' ? Flexible(child: Text(attachmentName)) : const Text(''),
