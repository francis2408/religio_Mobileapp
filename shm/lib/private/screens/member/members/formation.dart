                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                SizedBox(width: size.width * 0.02,),
                                                formation[index]['house_id'].isNotEmpty &&formation[index]['house_id'] != '' && formation[index]['house_id'] != null ? Text('${formation[index]['house_id'][1]}', style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: emptyColor, fontStyle: FontStyle.italic),),
                                              ],
                                            ),
                                          ],
                                        ),
