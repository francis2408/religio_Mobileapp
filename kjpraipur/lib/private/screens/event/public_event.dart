                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    eventName.isNotEmpty && eventName != '' ? Text(eventName, style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02),) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: Colors.grey, fontStyle: FontStyle.italic),),
                                  ],
                                ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: size.width * 0.02,),
                                    startDate.isNotEmpty && startDate != '' ? Text(DateFormat('dd-MM-yyyy').format(DateFormat('yyyy-MM-dd').parse(startDate)), style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02),) : const Text(""),
                                    SizedBox(width: size.width * 0.05,),
                                    Text("-", style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02,),),
                                    SizedBox(width: size.width * 0.05,),
                                    endDate.isNotEmpty && endDate != '' ? Text(
                                      DateFormat('dd-MM-yyyy').format(DateFormat('yyyy-MM-dd').parse(endDate)), style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02,),
                                    ) : Text(
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: size.width * 0.02,),
                                    eventLocation.isNotEmpty && eventLocation != '' ? Text(eventLocation, style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02),) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: Colors.grey, fontStyle: FontStyle.italic),),
                                  ],
                                ),
                              ],
                            ),
