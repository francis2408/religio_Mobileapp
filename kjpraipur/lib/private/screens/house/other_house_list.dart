...
class _OtherHouseListScreenState extends State<OtherHouseListScreen> {
  ...
  getHouseData() async {
    var request = http.Request('GET', Uri.parse("$baseUrl/search_read/res.community?domain=[('id','!=',$userCommunityId)]&fields=['image_1920','name','ministry_ids','diocese_id','parish_id','superior_id','street','street2','place','city','district_id','state_id','zip','country_id','email','phone','mobile','members_count','institution_count']&limit=40&offset=0"));
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              houseData[index]['superior_id'].isNotEmpty && houseData[index]['superior_id'] != null ? Flexible(
                                                child: Text(
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                image: DecorationImage(
                                                  ...
                                                  image: houseData[index]['image_1920'] != null && houseData[index]['image_1920'] != ''
