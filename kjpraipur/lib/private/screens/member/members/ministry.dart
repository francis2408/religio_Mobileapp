                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        houseName != null && houseName != '' ? Flexible(child: Text(houseName, style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02),)) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: Colors.grey, fontStyle: FontStyle.italic),),
                                      ],
                                    ),
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: size.width * 0.02,),
                                        dateFrom != null && dateFrom != '' ? Text(dateFrom, style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02),) : const Text(""),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(width: size.width * 0.02,),
                                        role != null && role != '' ? Flexible(child: Text(role, style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02),)) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: Colors.grey, fontStyle: FontStyle.italic),),
                                      ],
                                    ),
                                    SizedBox(height: size.height * 0.015,),
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(width: size.width * 0.02,),
                                        institution != null && institution != '' ? Flexible(child: Text(institution, style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02),)) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: Colors.grey, fontStyle: FontStyle.italic),),
                                      ],
                                    ),
                                  ],
                                ),
