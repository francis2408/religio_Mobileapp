...
class _MembersEducationScreenState extends State<MembersEducationScreen> with TickerProviderStateMixin {
  ...
  getEducationData() async {
    String educationUrl = '';
    educationUrl = "$baseUrl/search_read/res.member.education?domain=[('member_id','=',$id)]&fields=['study_level_id','program_id','institution','year_of_passing','state','mode','result','attachment']&order=year_of_passing asc";
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  SizedBox(width: size.width * 0.02,),
                                                  education[index]['program_id'] != [] && education[index]['program_id'].isNotEmpty ? Text("${education[index]['program_id'][1]}", style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02),) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: Colors.grey, fontStyle: FontStyle.italic),),
                                                ],
                                              ),
                                              SizedBox(height: size.height * 0.015,),
                                              Row(
