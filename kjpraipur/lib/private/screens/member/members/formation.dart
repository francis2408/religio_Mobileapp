...
class _MembersFormationScreenState extends State<MembersFormationScreen> with TickerProviderStateMixin {
  ...
  getFormationData() async {
    String formationUrl = '';
    formationUrl = "$baseUrl/search_read/res.formation?domain=[('member_id','=',$id)]&fields=['formation_stage_id','house_id','start_year','end_year','study_info','state']&order=start_year asc";
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                formation[index]['formation_stage_id'] != [] && formation[index]['formation_stage_id'].isNotEmpty ? Text(formation[index]['formation_stage_id'][1], style: GoogleFonts.secularOne(color: Colors.black, fontSize: size.height * 0.02),) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: Colors.grey, fontStyle: FontStyle.italic),),
                                              ],
                                            ),
