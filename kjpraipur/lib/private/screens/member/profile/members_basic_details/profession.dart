...
class _MemberProfessionScreenState extends State<MemberProfessionScreen> with TickerProviderStateMixin {
  ...
  getProfessionData() async {
    ...
    professionUrl = "$baseUrl/search_read/res.profession?domain=[('member_id','=',$memberId)]&fields=['profession_date','place','type','years','state']&order=profession_date asc";
