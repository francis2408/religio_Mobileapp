...
class _MemberStatutoryRenewalsScreenState extends State<MemberStatutoryRenewalsScreen> with TickerProviderStateMixin {
  ...
  getMemberStatutoryData() async {
    var request = http.Request('GET', Uri.parse("$baseUrl/search_read/member.statutory.renewals?domain=[('member_id','=',$memberId)]&fields=['no','document_type_id','valid_from','valid_to','agency','next_renewal']"));
