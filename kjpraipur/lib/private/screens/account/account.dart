...
import 'package:kjpraipur/private/screens/authentication/change_password.dart';
                        ...
                        child: Row(
                          children: [
                            Container(
                                ...
                                child: SvgPicture.asset('assets/icons/user.svg', color: Colors.white, height: 20, width: 20)
                            ),
                            SizedBox(width: size.width * 0.05),
                            Expanded(child: Text('About', style: TextStyle(fontSize: size.height * 0.019, color: Colors.black, fontWeight: FontWeight.w600),)),
                            Icon(Icons.arrow_forward_ios, color: Colors.black, size: size.height * 0.02,),
                          ],
                        ),
                      ),
                    ),
                        ...
                        child: Row(
                          children: [
                            Container(
                                ...
                                child: SvgPicture.asset('assets/icons/shield.svg', color: Colors.white, height: 20, width: 20)
                            ),
                            SizedBox(width: size.width * 0.05),
                            Expanded(child: Text('Privacy', style: TextStyle(fontSize: size.height * 0.019, color: Colors.black, fontWeight: FontWeight.w600),)),
                            Icon(Icons.arrow_forward_ios, color: Colors.black, size: size.height * 0.02,),
                          ],
                        ),
                      ),
                        ...
                        child: Row(
                          children: [
                            Container(
                                ...
                                child: SvgPicture.asset('assets/icons/key.svg', color: Colors.white, height: 20, width: 20)
                            ),
                            SizedBox(width: size.width * 0.05),
                            Expanded(child: Text('Change Password', style: TextStyle(fontSize: size.height * 0.019, color: Colors.black, fontWeight: FontWeight.w600),)),
                            Icon(Icons.arrow_forward_ios, color: Colors.black, size: size.height * 0.02,),
                          ],
                        ),
                      ),
                        ...
                        child: Row(
                          children: [
                            Container(
                                ...
                                child: Icon(Icons.cancel, size: size.height * 0.025, color: Colors.white,)
                            ),
                            SizedBox(width: size.width * 0.05),
                        ...
                        child: Row(
                          children: [
                            Container(
                                ...
                                child: SvgPicture.asset('assets/icons/logout.svg', color: Colors.white, height: 20, width: 20)
                            ),
                            SizedBox(width: size.width * 0.05),
