...
import 'package:nagpur/private/screens/news/add_news.dart';
...
class _NewsScreenState extends State<NewsScreen> {
  ...
  getNewsData() async {
    var request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.news?domain=[('rel_province_id','=',$userProvinceId),('type','=','Province'),('state','in',['publish','unpublished'])]&fields=['name','state','description','date','upload_image']&order=date desc"""));
