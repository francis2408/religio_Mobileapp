...
class _MembersListScreenState extends State<MembersListScreen> {
  ...
  void _loadMore() async {
    if (_hasNextPage == true &&
      ...
      if(memberSelectedTab == "All") {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId)]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=member_type_ord, name asc"""));
      } else if(memberSelectedTab == 'Priest') {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('member_type','=','Priest')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc"""));
      } else if(memberSelectedTab == 'Deacon') {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('member_type','=','Deacon')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc"""));
      } else if(memberSelectedTab == 'Brother') {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('member_type','=','Brother')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc"""));
      } else {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('member_type','=','Novice')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc"""));
      }
  ...
  Future<void> getMembersListData(String searchWord) async {
    ...
    var request;
    if(memberSelectedTab == "All") {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|','|','|',('name','ilike','$searchName'),('middle_name','ilike','$searchName'),('last_name','ilike','$searchName'),('member_name','ilike','$searchName'),('rel_province_id','=',$userProvinceId)]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=member_type_ord, name asc"""));
    } else if(memberSelectedTab == 'Priest') {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|','|','|',('name','ilike','$searchName'),('middle_name','ilike','$searchName'),('last_name','ilike','$searchName'),('member_name','ilike','$searchName'),('rel_province_id','=',$userProvinceId),('member_type','=','Priest')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=name asc"""));
    } else if(memberSelectedTab == 'Deacon') {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|','|','|',('name','ilike','$searchName'),('middle_name','ilike','$searchName'),('last_name','ilike','$searchName'),('member_name','ilike','$searchName'),('rel_province_id','=',$userProvinceId),('member_type','=','Deacon')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=name asc"""));
    } else if(memberSelectedTab == 'Brother') {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|','|','|',('name','ilike','$searchName'),('middle_name','ilike','$searchName'),('last_name','ilike','$searchName'),('member_name','ilike','$searchName'),('rel_province_id','=',$userProvinceId),('member_type','=','Brother')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=name asc"""));
    } else {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|','|','|',('name','ilike','$searchName'),('middle_name','ilike','$searchName'),('last_name','ilike','$searchName'),('member_name','ilike','$searchName'),('rel_province_id','=',$userProvinceId),('member_type','=','Novice')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=name asc"""));
    }
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
