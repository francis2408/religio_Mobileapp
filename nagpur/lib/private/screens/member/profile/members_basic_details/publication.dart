...
import 'package:nagpur/private/screens/member/publication/add_publication.dart';
import 'package:nagpur/private/screens/member/publication/edit_publication.dart';
...
class MemberPublicationScreen extends StatefulWidget {
  const MemberPublicationScreen({Key? key}) : super(key: key);

  @override
  State<MemberPublicationScreen> createState() => _MemberPublicationScreenState();
}

class _MemberPublicationScreenState extends State<MemberPublicationScreen> {
  ...
  getMemberPublicationData() async {
    var request = http.Request('GET', Uri.parse("$baseUrl/search_read/res.publication?domain=[('member_id','=',$memberId)]&fields=['publication_date','title','publisher','royalty','publication_type_id']&order=publication_date desc"));
