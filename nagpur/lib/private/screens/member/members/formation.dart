                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                SizedBox(width: size.width * 0.02,),
                                                formation[index]['institution'] != '' && formation[index]['institution'] != null ? Text('${formation[index]['institution']}', style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: emptyColor, fontStyle: FontStyle.italic),),
                                              ],
                                            ),
                                          ],
                                        ),
