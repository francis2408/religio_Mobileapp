...
import 'package:nagpur/private/screens/member/emergency_contact/add_emergency_contact.dart';
import 'package:nagpur/private/screens/member/emergency_contact/edit_emergency_contact.dart';
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            emergency[index]['emer_phone'] != null && emergency[index]['emer_phone'] != '' ? Text('${emergency[index]['emer_phone']}', style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: emptyColor, fontStyle: FontStyle.italic),),
