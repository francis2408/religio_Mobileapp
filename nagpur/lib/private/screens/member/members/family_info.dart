...
import 'package:nagpur/private/screens/member/family_info/add_family_info.dart';
import 'package:nagpur/private/screens/member/family_info/edit_family_info.dart';
...
class MembersFamilyInfoScreen extends StatefulWidget {
  const MembersFamilyInfoScreen({Key? key}) : super(key: key);

  @override
  State<MembersFamilyInfoScreen> createState() => _MembersFamilyInfoScreenState();
}

class _MembersFamilyInfoScreenState extends State<MembersFamilyInfoScreen> {
  ...
  getFamilyData() async {
    ...
    familyUrl = "$baseUrl/search_read/res.religious.family?domain=[('member_id','=',$id)]&fields=['name','gender','relationship','contact_number','occupation','birth_date']&order=relationship asc";
                                  ...
                                  child: Column(
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Container(width: size.width * 0.15, alignment: Alignment.topLeft, child: Text('Name', style: GoogleFonts.signika(fontSize: size.height * 0.02, fontStyle: FontStyle.italic, color: labelColor),)),
                                          Flexible(child: Text(family[index]['name'] + ' ' + '(${family[index]['relationship'] == 'Parent' && family[index]['gender'] == 'Male' ? 'Father' : family[index]['relationship'] == 'Parent' && family[index]['gender'] == 'Female' ? 'Mother' : 'Siblings'})', style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),)),
                                        ],
                                      ),
                                      family[index]['contact_number'] != null && family[index]['contact_number'] != '' ? Container() : SizedBox(height: size.height * 0.015,),
                                      Row(
                                        children: [
                                          Container(width: size.width * 0.15, alignment: Alignment.topLeft, child: Text('Mobile', style: GoogleFonts.signika(fontSize: size.height * 0.02, fontStyle: FontStyle.italic, color: labelColor),)),
                                          family[index]['contact_number'] != null && family[index]['contact_number'] != '' ? Text('${family[index]['contact_number']}', style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: emptyColor, fontStyle: FontStyle.italic),),
                                          ...
                                          family[index]['contact_number'] != null && family[index]['contact_number'] != '' ? Row(
                                            ...
                                            children: [
                                              ...
                                              IconButton(
                                                icon: family[index]['contact_number'] != null && family[index]['contact_number'] != "" ? SvgPicture.asset('assets/icons/whatsapp.svg', color: whatsAppColor, height: 20, width: 20,) : Container(),
                                                color: whatsAppColor,
                                                onPressed: () {
