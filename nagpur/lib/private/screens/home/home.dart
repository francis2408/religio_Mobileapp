...
import 'package:nagpur/private/screens/account/about.dart';
import 'package:nagpur/private/screens/authentication/change_password.dart';
import 'package:nagpur/private/screens/celebration/celebration_tab.dart';
import 'package:nagpur/private/screens/circular&news_letter/circular_and_newsletter_tab.dart';
import 'package:nagpur/private/screens/event/event.dart';
import 'package:nagpur/private/screens/house/house.dart';
import 'package:nagpur/private/screens/house/house_institution_list.dart';
import 'package:nagpur/private/screens/house/house_members_list.dart';
import 'package:nagpur/private/screens/institution/institution.dart';
import 'package:nagpur/private/screens/institution/institution_members_list.dart';
import 'package:nagpur/private/screens/institution/province_and_institution_tab.dart';
import 'package:nagpur/private/screens/member/member_tab.dart';
import 'package:nagpur/private/screens/member/members_details.dart';
import 'package:nagpur/private/screens/member/profile/member_profile_details.dart';
import 'package:nagpur/private/screens/news/news.dart';
import 'package:nagpur/private/screens/news/news_detail.dart';
import 'package:nagpur/private/screens/notification/notification_list.dart';
import 'package:nagpur/private/screens/obituary/obituary_tab.dart';
import 'package:nagpur/private/screens/province/province_details.dart';
import 'package:nagpur/private/screens/province/province_house_list.dart';
import 'package:nagpur/private/screens/province/province_institution_list.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:nagpur/private/screens/authentication/login.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List newsList = [
    "Welcome to prabhu prakash province - Nagpur.",
  ];
  ...
  getTodayOrdinationData() async {
    ...
    if (response.statusCode == 200) {
      var result = json.decode(await response.stream.bytesToString());
      var today = DateFormat('dd - MMMM').format(DateTime.now());
      if(result['data']['next_30_ordinations'] != []) {
        List data = result['data']['next_30_ordinations'];
        for(int i = 0; i < data.length; i++) {
          var formattedDate = data[i]['od'];
          if(today == formattedDate) {
            todayOrdination.add(data[i]);
          }
        }
        setState(() {
          ordinationCount = todayOrdination.length.toString();
          if(ordinationCount != null && ordinationCount != '') {
            total += int.parse(ordinationCount);
          }
        });
      }
    } else {
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            bottom: PreferredSize(
              preferredSize: Size.fromHeight(size.height * 0.2), // Set the preferred height
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text('PRABHU PRAKASH PROVINCE', style: TextStyle(fontSize: size.height * 0.023, fontWeight: FontWeight.bold, color: Colors.white),),
                    Container(
                      height: size.height * 0.12, // Increase the height
                      width: size.width * 0.3,  // Increase the width
                      decoration: const BoxDecoration(
                        shape: BoxShape.circle,
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: AssetImage('assets/images/nagpur2.png'),
                        ),
                      ),
                    ),
                    Text('PALLOTTINES', style: TextStyle(fontSize: size.height * 0.023, fontWeight: FontWeight.bold, color: Colors.white),),
                    Text('Society of the Catholic Apostolate', style: GoogleFonts.cookie(letterSpacing: 0.8, fontSize: size.height * 0.022, color: Colors.white, fontStyle: FontStyle.italic),)
                  ],
                ),
              ),
            ),
                              ...
                              itemBuilder: (context, index, realIndex) {
                                ...
                                return GestureDetector(
                                  onTap: () async {
                                    ...
                                    } else if(newsData[index]['type'] == 'ordination') {
                                      id = newsData[index]['id'];
                                      if(memberId == id) {
                                        memberId = id;
                                        String refresh = await Navigator.push(context,
                                  ...
                                  child: Container(
                                    ...
                                    ) : newsData[index]['type'] == 'ordination' ? Row(
                                      children: [
                                        Flexible(
                                          child: Text(
                                            "Happy Ordination Day to $news",
                                            textAlign: TextAlign.left,
                                            maxLines: 2,
                                            overflow: TextOverflow.ellipsis,
                                            style: GoogleFonts.maitree(
                        ...
                        children: [
                          ...
                          userRole == 'Religious Province' ? HomeCard(
                            onPressed: () async {
                              ...
                              String refresh = await Navigator.push(context, CustomRoute(widget: const ParishAndInstitutionTabScreen()));
                    ...
                    TextButton(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(child: Text('Profile', style: TextStyle(fontSize: size.height * 0.018, color: valueColor, fontWeight: FontWeight.w600),)),
                    ...
                    TextButton(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: size.width * 0.05),
                          Expanded(child: Text('About', style: TextStyle(fontSize: size.height * 0.018, color: valueColor, fontWeight: FontWeight.w600),)),
                          Icon(Icons.arrow_forward_ios, color: valueColor, size: size.height * 0.02,),
                        ],
                      ),
                    ),
                    ...
                    TextButton(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: size.width * 0.05),
                          Expanded(child: Text('Privacy', style: TextStyle(fontSize: size.height * 0.018, color: valueColor, fontWeight: FontWeight.w600),)),
                          Icon(Icons.arrow_forward_ios, color: valueColor, size: size.height * 0.02,),
                        ],
                      ),
                    ),
                    ...
                    TextButton(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: size.width * 0.05),
                          Expanded(child: Text('Change Password', style: TextStyle(fontSize: size.height * 0.018, color: valueColor, fontWeight: FontWeight.w600),)),
                          Icon(Icons.arrow_forward_ios, color: valueColor, size: size.height * 0.02,),
                        ],
                      ),
                    ),
                      ...
                      child: Row(
                        children: [
                          Container(
                              ...
                              child: const Icon(Icons.cancel, size: 20, color: buttonIconColor,)
                          ),
                          SizedBox(width: size.width * 0.05),
                          Expanded(child: Text('Exit', style: TextStyle(fontSize: size.height * 0.018, color: valueColor, fontWeight: FontWeight.w600),)),
                        ],
                      ),
                    ),
                    SizedBox(
