...
class _ProvinceInstitutionListScreenState extends State<ProvinceInstitutionListScreen> {
  ...
  void _loadMore() async {
    if (_hasNextPage == true &&
      ...
      page += limit;
      var request = parishTab == 'Parishes' ? http.Request('GET', Uri.parse("""$baseUrl/search_read/res.institution?domain=[('rel_province_id','=',$userProvinceId),('is_abroad','=',False),('is_other_diocese','=',False),('institution_category_id.name','=','Pastoral'),('ministry_category_id','in',[$parishesId,$missionId])]&fields=['name','image_512','superior_id','ministry_category_id','members_count']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc""")) : http.Request('GET', Uri.parse("""$baseUrl/search_read/res.institution?domain=[('rel_province_id','=',$userProvinceId),('is_abroad','=',False),('is_other_diocese','=',False),('institution_category_id','!=',$categoryId)]&fields=['name','image_512','superior_id','ministry_category_id','members_count']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc"""));
  ...
  Future<void> getInstitutionListData(String searchWord) async {
    ...
    var request = parishTab == 'Parishes' ? http.Request('GET', Uri.parse("""$baseUrl/search_read/res.institution?domain=[('name','ilike','$searchName'),('rel_province_id','=',$userProvinceId),('is_abroad','=',False),('is_other_diocese','=',False),('institution_category_id.name','=','Pastoral'),('ministry_category_id','in',[$parishesId,$missionId])]&fields=['name','image_512','superior_id','ministry_category_id','members_count']&context={"bypass":1}&limit=500&offset=0&order=name asc""")) : http.Request('GET', Uri.parse("""$baseUrl/search_read/res.institution?domain=[('name','ilike','$searchName'),('rel_province_id','=',$userProvinceId),('is_abroad','=',False),('is_other_diocese','=',False),('institution_category_id','!=',$categoryId)]&fields=['name','image_512','superior_id','ministry_category_id','members_count']&context={"bypass":1}&limit=500&offset=0&order=name asc"""));
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
