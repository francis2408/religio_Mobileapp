// Test Server
// const baseUrl = 'http://testpallottinagpur.cristolive.org/api';
// const db = 'cristo_testpallottinagpur';
// Live Server
const baseUrl = 'https://data.napallottines.org/api';
const db = 'cristo_pallotti_nagpur';
