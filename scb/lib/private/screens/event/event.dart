...
import 'package:scb/private/screens/event/all_event.dart';
...
class _EventScreenState extends State<EventScreen> with SingleTickerProviderStateMixin {
  ...
  List tabs = userRole == 'Religious Province' ? ["All", "Upcoming", "My Calendar", "Provincial", "Province"] : userRole == 'House/Community' ? ["All", "Upcoming", "My Calendar", "Province", "Community"] : ["All", "Upcoming", "My Calendar", "Province", "Community"];
