...
class _MembersListScreenState extends State<MembersListScreen> {
  ...
  void _loadMore() async {
    if (_hasNextPage == true &&
      ...
      if(memberSelectedTab == "All") {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId)]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=profession_date,name,middle_name,last_name asc"""));
      } else if(memberSelectedTab == 'Sister') {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('member_type','=','Sister')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=profession_date,name,middle_name,last_name asc"""));
      } else if(memberSelectedTab == 'Junior Sister') {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('member_type','=','Junior Sister')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=profession_date,name,middle_name,last_name asc"""));
      } else if(memberSelectedTab == 'Novice') {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('member_type','=','Novice')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=profession_date,name,middle_name,last_name asc"""));
      } else if(memberSelectedTab == 'Candidacy') {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('member_type','=','Candidacy')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=profession_date,name,middle_name,last_name asc"""));
      } else if(memberSelectedTab == 'Postulancy') {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('member_type','=','Postulancy')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=profession_date,name,middle_name,last_name asc"""));
      } else {
        request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=[('rel_province_id','=',$userProvinceId),('member_type','=','Retired Sister')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=$limit&offset=$page&order=profession_date,name,middle_name,last_name asc"""));
      }
  ...
  Future<void> getMembersListData(String searchWord) async {
    ...
    var request;
    if(memberSelectedTab == "All") {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|',('member_name','ilike','$searchName'),('rel_province_id','=',$userProvinceId)]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=profession_date,name,middle_name,last_name asc"""));
    } else if(memberSelectedTab == 'Sister') {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|',('member_name','ilike','$searchName'),('rel_province_id','=',$userProvinceId),('member_type','=','Sister')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=profession_date,name,middle_name,last_name asc"""));
    } else if(memberSelectedTab == 'Junior Sister') {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|',('member_name','ilike','$searchName'),('rel_province_id','=',$userProvinceId),('member_type','=','Junior Sister')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=profession_date,name,middle_name,last_name asc"""));
    } else if(memberSelectedTab == 'Novice') {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|',('member_name','ilike','$searchName'),('rel_province_id','=',$userProvinceId),('member_type','=','Novice')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=profession_date,name,middle_name,last_name asc"""));
    } else if(memberSelectedTab == 'Candidacy') {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|',('member_name','ilike','$searchName'),('rel_province_id','=',$userProvinceId),('member_type','=','Candidacy')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=profession_date,name,middle_name,last_name asc"""));
    } else if(memberSelectedTab == 'Postulancy') {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|',('member_name','ilike','$searchName'),('rel_province_id','=',$userProvinceId),('member_type','=','Postulancy')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=profession_date,name,middle_name,last_name asc"""));
    } else {
      request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.member?domain=['|',('member_name','ilike','$searchName'),('rel_province_id','=',$userProvinceId),('member_type','=','Retired Sister')]&fields=['member_name','image_512','role_ids','mobile','member_type','community_id']&context={"bypass":1}&limit=500&order=profession_date,name,middle_name,last_name asc"""));
    }
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
                                                    ...
                                                    Positioned(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                          ...
                                                          color: results[index]['member_type'] == 'Sister' ? Colors.green : results[index]['member_type'] == 'Junior Sister' ? Colors.pinkAccent : results[index]['member_type'] == 'Novice' ? Colors.indigo : results[index]['member_type'] == 'Candidacy' ? Colors.cyan : results[index]['member_type'] == 'Postulancy' ? Colors.purpleAccent : Colors.redAccent,
                                                        ),
                                                        ...
                                                        ) : results[index]['member_type'] == 'Junior Sister' ? Text('JS',
                                                          style: GoogleFonts.heebo(
                                                              fontSize: size.height * 0.02,
                                                              color: Colors.white,
                                                              fontWeight: FontWeight.bold
                                                        ...
                                                        ) : results[index]['member_type'] == 'Candidacy' ? Text('C',
                                                          style: GoogleFonts.heebo(
                                                              fontSize: size.height * 0.02,
                                                              color: Colors.white,
                                                              fontWeight: FontWeight.bold
                                                          ),
                                                        ) : results[index]['member_type'] == 'Postulancy' ? Text('PO',
                                                          style: GoogleFonts.heebo(
                                                              fontSize: size.height * 0.02,
                                                              color: Colors.white,
                                                              fontWeight: FontWeight.bold
                                                  ...
                                                  children: [
                                                    ...
                                                    Positioned(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                          borderRadius: BorderRadius.circular(5),
                                                          color: members[index]['member_type'] == 'Sister' ? Colors.green : members[index]['member_type'] == 'Junior Sister' ? Colors.pinkAccent : members[index]['member_type'] == 'Novice' ? Colors.indigo : members[index]['member_type'] == 'Candidacy' ? Colors.cyan : members[index]['member_type'] == 'Postulancy' ? Colors.purple : Colors.redAccent,
                                                        ),
                                                        ...
                                                        ) : members[index]['member_type'] == 'Junior Sister' ? Text('JS',
                                                          style: GoogleFonts.heebo(
                                                              fontSize: size.height * 0.02,
                                                              color: Colors.white,
                                                              fontWeight: FontWeight.bold
                                                        ...
                                                        ) : members[index]['member_type'] == 'Candidacy' ? Text('C',
                                                          style: GoogleFonts.heebo(
                                                              fontSize: size.height * 0.02,
                                                              color: Colors.white,
                                                              fontWeight: FontWeight.bold
                                                          ),
                                                        ) : members[index]['member_type'] == 'Postulancy' ? Text('PO',
                                                          style: GoogleFonts.heebo(
                                                              fontSize: size.height * 0.02,
                                                              color: Colors.white,
                                                              fontWeight: FontWeight.bold
