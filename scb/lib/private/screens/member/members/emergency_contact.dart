...
import 'package:scb/private/screens/member/emergency_contact/add_emergency_contact.dart';
import 'package:scb/private/screens/member/emergency_contact/edit_emergency_contact.dart';
                                    ...
                                    child: Column(
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Container(width: size.width * 0.2, alignment: Alignment.topLeft, child: Text('Name', style: GoogleFonts.signika(fontSize: size.height * 0.02, fontStyle: FontStyle.italic, color: labelColor),)),
                                            emergency[index]['emer_name'] != '' && emergency[index]['emer_name'] != null ? Flexible(child: Text('${emergency[index]['emer_name']}', style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),)) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: emptyColor, fontStyle: FontStyle.italic),),
                                          ],
                                        ),
                                        ...
                                        Row(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Container(width: size.width * 0.2, alignment: Alignment.topLeft, child: Text('Relation', style: GoogleFonts.signika(fontSize: size.height * 0.02, fontStyle: FontStyle.italic, color: labelColor),)),
                                            emergency[index]['emer_relationship_id'] != null && emergency[index]['emer_relationship_id'].isNotEmpty ? Flexible(child: Text('${emergency[index]['emer_relationship_id'][1]}', style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),)) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: emptyColor, fontStyle: FontStyle.italic),),
                                          ],
                                        ),
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            emergency[index]['emer_phone'] != '' && emergency[index]['emer_phone'] != null ? IntrinsicHeight(
                                              child: (emergency[index]['emer_phone']).split(',').length != 1 ? Row(
                                                children: [
                                                  GestureDetector(
                                                    onTap: () {
                                                      showDialog(
                                                            ...
                                                            content: Row(
                                                              ...
                                                              children: [
                                                                IconButton(
                                                                  onPressed: () {
                                                                    Navigator.pop(context);
                                                                    callAction((emergency[index]['emer_phone']).split(',')[0].trim());
                                                                  },
                                                                ...
                                                                IconButton(
                                                                  onPressed: () {
                                                                    Navigator.pop(context);
                                                                    smsAction((emergency[index]['emer_phone']).split(',')[0].trim());
                                                                  },
                                                                ...
                                                                IconButton(
                                                                  onPressed: () {
                                                                    Navigator.pop(context);
                                                                    whatsappAction((emergency[index]['emer_phone']).split(',')[0].trim());
                                                                  },
                                                    ...
                                                    child: Text(
                                                      (emergency[index]['emer_phone']).split(',')[0].trim(),
                                                  ...
                                                  GestureDetector(
                                                            ...
                                                            content: Row(
                                                              ...
                                                              children: [
                                                                IconButton(
                                                                  onPressed: () {
                                                                    Navigator.pop(context);
                                                                    callAction((emergency[index]['emer_phone']).split(',')[1].trim());
                                                                  },
                                                                  icon: const Icon(Icons.phone),
                                                                  color: callColor,
                                                                ),
                                                                IconButton(
                                                                  onPressed: () {
                                                                    Navigator.pop(context);
                                                                    smsAction((emergency[index]['emer_phone']).split(',')[1].trim());
                                                                  },
                                                                  icon: const Icon(Icons.message),
                                                                  color: smsColor,
                                                                ),
                                                                IconButton(
                                                                  onPressed: () {
                                                                    Navigator.pop(context);
                                                                    whatsappAction((emergency[index]['emer_phone']).split(',')[1].trim());
                                                                  },
                                                                  icon: SvgPicture.asset('assets/icons/whatsapp.svg', color: whatsAppColor, height: 20, width: 20,),
                                                                  color: whatsAppColor,
                                                                ),
                                                    ...
                                                    child: Text(
                                                      (emergency[index]['emer_phone']).split(',')[1].trim(),
                                                      style: GoogleFonts.secularOne(
                                                          color: mobileText,
                                                          fontSize: size.height * 0.02
                                                      ),
                                        ...
                                        (emergency[index]['emer_phone']).split(',').length != 1 ? SizedBox(height: size.height * 0.015,) : Container(),
                                        Row(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            ...
                                            emergency[index]['emer_street'].isEmpty && emergency[index]['emer_street2'].isEmpty &&
                                              ...
                                              child: Column(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  emergency[index]['emer_street'] != '' && emergency[index]['emer_street'] != null ? Text("${emergency[index]['emer_street']},", style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),) : Container(),
                                                  emergency[index]['emer_street2'] != '' && emergency[index]['emer_street2'] != null ? Text("${emergency[index]['emer_street2']},", style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),) : Container(),
                                                  emergency[index]['emer_place'] != '' && emergency[index]['emer_place'] != null ? Text("${emergency[index]['emer_place']},", style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),) : Container(),
                                                  emergency[index]['emer_city'] != '' && emergency[index]['emer_city'] != null ? Text("${emergency[index]['emer_city']},", style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),) : Container(),
                                                  emergency[index]['emer_district_id'] != [] && emergency[index]['emer_district_id'].isNotEmpty ? Text("${emergency[index]['emer_district_id'][1]},", style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),) : Container(),
                                                  emergency[index]['emer_state_id'] != [] && emergency[index]['emer_state_id'].isNotEmpty ? Text("${emergency[index]['emer_state_id'][1]},", style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),) : Container(),
                                                  emergency[index]['emer_country_id'] != [] && emergency[index]['emer_country_id'].isNotEmpty ? Row(
                                                    children: [
                                                      emergency[index]['emer_country_id'] != [] && emergency[index]['emer_country_id'].isNotEmpty ? Text("${emergency[index]['emer_country_id'][1]}", style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),) : Container(),
                                                      emergency[index]['emer_zip'] != '' && emergency[index]['emer_zip'] != null ? Text("-", style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),) : Container(),
                                                      emergency[index]['emer_zip'] != '' && emergency[index]['emer_zip'] != null ? Text("${emergency[index]['emer_zip']}.", style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),) : Container()
                                                    ],
                                                  ) : Container(),
                                                ],
                                              ),
