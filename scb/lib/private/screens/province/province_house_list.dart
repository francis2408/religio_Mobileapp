...
import 'package:scb/private/screens/house/other_house_details.dart';
import 'package:scb/private/screens/house/other_house_institution_list.dart';
import 'package:scb/private/screens/house/other_house_members_list.dart';
...
class _ProvinceHouseListScreenState extends State<ProvinceHouseListScreen> {
  ...
  void _loadMore() async {
    if (_hasNextPage == true &&
      ...
      page += limit;
      var request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.community?domain=[('rel_province_id','=',$userProvinceId),('is_abroad','=',False),('is_other_diocese','=',False)]&fields=['image_512','name','superior_id','ministry_ids','members_count','institution_count','position_ids']&context={"bypass":1}&limit=$limit&offset=$page&order=name asc"""));
  ...
  Future<void> getHouseListData(String searchWord) async {
    ...
    var request = http.Request('GET', Uri.parse("""$baseUrl/search_read/res.community?domain=[('name','ilike','$searchName'),('rel_province_id','=',$userProvinceId),('is_abroad','=',False),('is_other_diocese','=',False)]&fields=['image_512','name','superior_id','ministry_ids','members_count','institution_count','position_ids']&context={"bypass":1}&limit=500&offset=0&order=name asc"""));
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
                                                      ...
                                                      children: [
                                                        Flexible(
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                                text: results[index]['superior_id'][1],
                                                                style: GoogleFonts.secularOne(
                                                                    fontSize: size.height * 0.018,
                                                                    color: emptyColor,
                                                                    fontStyle: FontStyle.italic
                                                                ),
                                                                children: results[index]['position_ids_name'] != null && results[index]['position_ids_name'] != '' ? [
                                                                  const TextSpan(
                                                                    text: '  ',
                                                                  ),
                                                                  TextSpan(
                                                                    text: '(${results[index]['position_ids_name']})',
                                                                    style: TextStyle(
                                                                        fontSize: size.height * 0.018,
                                                                        color: emptyColor,
                                                                        fontStyle: FontStyle.italic
                                                      ...
                                                      children: [
                                                        Flexible(
                                                          child: RichText(
                                                            textAlign: TextAlign.left,
                                                            text: TextSpan(
                                                                text: houseData[index]['superior_id'][1],
                                                                style: GoogleFonts.secularOne(
                                                                    fontSize: size.height * 0.018,
                                                                    color: emptyColor,
                                                                    fontStyle: FontStyle.italic
                                                                ),
                                                                children: houseData[index]['position_ids_name'] != null && houseData[index]['position_ids_name'] != '' ? [
                                                                  const TextSpan(
                                                                    text: '  ',
                                                                  ),
                                                                  TextSpan(
                                                                    text: '(${houseData[index]['position_ids_name']})',
                                                                    style: TextStyle(
                                                                        fontSize: size.height * 0.018,
                                                                        color: emptyColor,
                                                                        fontStyle: FontStyle.italic
