                                            ...
                                            children: [
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  borderRadius: BorderRadius.circular(10),
                                                  boxShadow: <BoxShadow>[
                                                    if(otherMembers[index]['image_512'] != null && otherMembers[index]['image_512'] != '') const BoxShadow(
                                                      color: Colors.grey,
                                                      spreadRadius: -1,
                                                      blurRadius: 5 ,
                                                      offset: Offset(0, 1),
                                              ...
                                              Positioned(
                                                ...
                                                child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    ...
                                                    color: otherMembers[index]['member_type'] == 'Sister' ? Colors.green : otherMembers[index]['member_type'] == 'Junior Sister' ? Colors.pinkAccent : otherMembers[index]['member_type'] == 'Novice' ? Colors.indigo : otherMembers[index]['member_type'] == 'Candidacy' ? Colors.cyan : otherMembers[index]['member_type'] == 'Postulancy' ? Colors.purple : Colors.redAccent,
                                                  ),
