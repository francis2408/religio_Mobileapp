...
class _OtherHouseDetailsScreenState extends State<OtherHouseDetailsScreen> {
  ...
  getOtherHouseData() async {
    var request = http.Request('GET', Uri.parse("$baseUrl/search_read/res.community?domain=[('id','=',$houseID)]&fields=['image_512','name','ministry_ids','diocese_id','parish_id','establishment_year','patron_id','founder','superior_id','street','street2','place','city','district_id','state_id','zip','country_id','email','phone','mobile','members_count','institution_count']&limit=40&offset=0"));
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        houseData[index]['patron_id'].isNotEmpty && houseData[index]['patron_id'] != [] ? Flexible(child: Text("${houseData[index]['patron_id'][1]}", style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),)) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: emptyColor, fontStyle: FontStyle.italic),),
                                      ],
                                    ),
                                    SizedBox(height: size.height * 0.01,),
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        houseData[index]['founder'].isNotEmpty && houseData[index]['founder'] != '' ? Flexible(child: Text("${houseData[index]['founder']}", style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),)) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: emptyColor, fontStyle: FontStyle.italic),),
                                      ],
                                    ),
                                  ],
                                ),
