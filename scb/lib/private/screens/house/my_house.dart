...
class _MyHouseScreenState extends State<MyHouseScreen> {
  ...
  houseDetails() async{
    var request = http.Request('GET', Uri.parse("$baseUrl/search_read/res.community?fields=['image_512','name','ministry_ids','diocese_id','parish_id','superior_id','patron_id','founder','street','street2','place','city','district_id','state_id','zip','country_id','email','phone','mobile','members_count','institution_count']&domain=[('id','=',$userCommunityId)]"));
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        house[index]['patron_id'].isNotEmpty && house[index]['patron_id'] != [] ? Flexible(child: Text("${house[index]['patron_id'][1]}", style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),)) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: emptyColor, fontStyle: FontStyle.italic),),
                                      ],
                                    ),
                                    SizedBox(height: size.height * 0.01,),
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        house[index]['founder'].isNotEmpty && house[index]['founder'] != '' ? Flexible(child: Text("${house[index]['founder']}", style: GoogleFonts.secularOne(color: valueColor, fontSize: size.height * 0.02),)) : Text("NA", style: GoogleFonts.secularOne(fontSize: size.height * 0.02, color: emptyColor, fontStyle: FontStyle.italic),),
                                      ],
                                    ),
                                  ],
                                ),
